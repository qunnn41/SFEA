...
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SFEAPackage.OPERATION__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(Feature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SFEAPackage.OPERATION__FEATURE, oldFeature, feature));
	}

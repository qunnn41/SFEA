 ...
 * </p>
 * <ul>
 *   <li>{@link moon.nju.edu.cn.fm.model.impl.ValueOperationImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueOperationImpl extends OperationImpl implements ValueOperation {
	...
	protected EClass eStaticClass() {
		return SFEAPackage.Literals.VALUE_OPERATION;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SFEAPackage.VALUE_OPERATION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SFEAPackage.VALUE_OPERATION__VALUE:
				return getValue();
		}
